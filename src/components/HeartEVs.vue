            ...
            <el-table :data="evs" size="medium" stripe style="width: 100%" class="table_wrap-table">
              ...
              <el-table-column label="操作" width="190">
                <template slot-scope="scope">
                  <div>
                    <el-button type="text" size="small" @click="handleEVoperation(scope,'EVwake')">通电</el-button>
                    <el-button @click="handleEVoperation(scope,'EVflameout')" type="text" size="small">断电</el-button>
                    <el-button type="text" size="small" @click="rrPush(scope.row,'track')">轨迹</el-button>
                    <el-button
                    ...
                    size="small"
                    >解绑</el-button>
                    <el-button v-else @click="handleEVbind(scope)" type="text" size="small">绑定</el-button>
                  </div>
                </template>
              </el-table-column>
            </el-table>
  ...
  data: function() {
    return {
      ...
      pageNum: window.Number(this.$route.params.pn)
        ? window.Number(this.$route.params.pn)
        : 1
    };
  },
  computed: {
